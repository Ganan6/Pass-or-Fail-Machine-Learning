...
result = train_df.info() # This prints the info of the data such as no of colums and rows.
...
sns.pairplot(train_df, hue='class-label', markers='o')
plt.show()

# PRE-PROCESS the data to see if you can improve the final classification**********


# SPLIT training data to test ML model *********************************************
